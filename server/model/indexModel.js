...
const _wedding_reviews = require('./wedding_reviews');
...
function initModels(sequelize) {
	...
	const wedding_reviews = _wedding_reviews(sequelize, DataTypes);
	...
	wedding_reviews.belongsTo(users, {
		as: 'wore_user',
		foreignKey: 'wore_user_id',
	});
	users.hasMany(wedding_reviews, {
		as: 'wedding_reviews',
		foreignKey: 'wore_user_id',
	});
	...
	wedding_reserve_lines.belongsTo(wedding_reserve, {
		as: 'writ_were',
		foreignKey: 'writ_were_id',
	});
	wedding_reserve.hasMany(wedding_reserve_lines, {
		as: 'wedding_reserve_lines',
		foreignKey: 'writ_were_id',
	});
	...
	wedding_reviews.belongsTo(wedding_vendor, {
		as: 'wore_weve',
		foreignKey: 'wore_weve_id',
	});
	wedding_vendor.hasMany(wedding_reviews, {
		as: 'wedding_reviews',
		foreignKey: 'wore_weve_id',
	});
